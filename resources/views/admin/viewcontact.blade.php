    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        @foreach ($res as $ad)
          ...
          <tr>
              <td><b>NAME</b></td>
              <td><h5 style="color:#476b6b">{{ $ad->name }}</h5></td>
          </tr>
          <tr>
          ...
          <tr>
              <td><b>SUBJECT</b></td>
              <td><h5 style="color:#476b6b">{{ $ad->subject }}</h5></td>
          </tr>
          <tr>
              <td><b>MESSAGE</b></td>
              <td><h4 style="color:#476b6b">{{ $ad->message }}</H4></td>
          </tr>
          <tr>
              <td></td>
              <td><button class="btn btn-dark"><a href={{ "/admin/showcontact" }}>BACK<a></button></td>
          </tr>
          </table>
        @endforeach
