    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <form action="{{ route('readcourse') }}" method="post" enctype="multipart/form-data">
                  @csrf
                <table class="table table-borderless">
                <tr>
                    <td><br><h3 style="color:#e6b800"><b>ADD COURSE</b></h3></td>
                </tr>
                <tr>
                    <td>COURSE NAME</td>
                ...
                <tr>
                    ...
                    <td><select name="depname">
                        ...
                        <option value="DEPARTMENT OF BUSINESS">DEPARTMENT OF BUSINESS</option>
                         </select>
                    </td>
                </tr>
                <tr>
                    <td>UG/PG</td>
                    <td>UG<input type="radio"  name="graduation" value="ug">&nbsp;&nbsp;&nbsp;
                    PG<input type="radio"  name="graduation" value="pg">&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <td>DEPARTMENT PHOTO</td>
                    <td><input type="file" name="departphoto" class="form-control"></td>
                </tr>
                <tr>
                    <td>COURSE PHOTO</td>
                    <td><input type="file" name="coursephoto" class="form-control"></td>
                </tr>
                <tr>
                    <td>DESCRIPTION</td>
                    <td>
                    <textarea id="" name="description" rows="8" cols="50">
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td><button class="btn btn-success">ADD COURSE</button></td>
                </tr>
                </table>
            </form>
