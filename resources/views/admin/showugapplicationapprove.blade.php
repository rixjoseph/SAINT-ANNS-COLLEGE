    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <form action="{{ route('readugapplicationreport') }}" method="post">
                  @csrf
...
<img src="{{ asset('uploads/photos/'. $addmi->photo) }}" class="card-img-top" height="250" width="200"  alt="">
  <div class="card-body">
    ...
    <p class="card-text"></p>
      ...
      <td><button class="btn btn-info" onclick="return confirm('Are you sure want to Approve?')"><a href="{{ URL('/approveug/'.$addmi->id) }}">APPROVE</a></button></td>
      <td><button class="btn btn-danger" onclick="return confirm('Are you sure want to Reject?')"><a href="{{ URL('/rejectug/'.$addmi->id) }}">REJECT</a></button></td>
    </tr>
  </tbody>
</table>
