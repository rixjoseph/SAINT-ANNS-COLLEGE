    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <br><h3 style="color:#e6b800"><b>MESSAGES AND ENQUIRIES</b></h3>
        ...
        <tr>
            ...
            <td>{{ $addmi->name }}</td>
            <td>{{ $addmi->subject }}</td>
            <td><button class="btn success"><a href="{{ URL('/admin/viewcontact/'.$addmi->id) }}">VIEW</a></button>
            <button class="btn btn-danger"><a href="{{ URL('/admin/delete/'.$addmi->id) }}">DELETE</a></button></td>
        </tr>
        </table>
        @endforeach
