      ...
      <section class="wrapper">
        <div class="row">
          ...
          <form action="" method="post">
                ...
                <tr>
                    <td><br><h3 style="color:#e6b800"><b>VIEW APPLICATON -COURSE WISE</b></h3></td>
                </tr>
                <tr>
                    <td>COURSE NAME</td>
...
<table class="table table-borderless">
  <thead>
    <tr>
      ...
      <th scope="col">DEGREE MARKLIST</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<img src="{{ asset('uploads/photos/'. $addmi->photo) }}" class="card-img-top" height="250" width="200"  alt="">
  <div class="card-body">
    <h5 class="card-title">{{ $addmi->fname }}</h5>
    <p class="card-text"></p>
  </div>
</div></td>
      <td></td>
      <td>{{ $addmi->id }}</td>
      <td>{{ $addmi->fathername }}</td>
      <td>{{ $addmi->mobileno }}</td>
      <td><b>{{ $addmi->status }}</b></td>
      <td>{{ $addmi->paystatus }}</td>
      <td><a href="{{ asset('uploads/sslc/'. $addmi->sslc) }}" download="{{ asset('uploads/sslc/'. $addmi->sslc) }}">DOWNLOAD</a></td>
      <td><a href="{{ asset('uploads/ug/'. $addmi->ug) }}" download="{{ asset('uploads/ug/'. $addmi->ug) }}">DOWNLOAD</a></td>
      <td><button class="btn btn-info" onclick="return confirm('Are you sure want to Approve?')"><a href="{{ URL('/approve/'.$addmi->id) }}">APPROVE</a></button></td>
      <td><button class="btn btn-danger" onclick="return confirm('Are you sure want to Reject?')"><a href="{{ URL('/reject/'.$addmi->id) }}">REJECT</a></button></td>
    </tr>
  </tbody>
</table>
