    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <form action="{{ route('readnotification') }}" method="post" enctype="multipart/form-data">
                  @csrf
                <table class="table table-borderless">
                <tr>
                    <td><br><h3 style="color:#e6b800"><b>ADD NOTIFICATION</b></h3></td>
                </tr>
                <tr>
                    <td>SCHOLARSHIP NEWS</td>
                    <td>
                    <textarea id="" name="scholarship" rows="8" cols="50">
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td>NOTICE BOARD</td>
                    <td>
                    <textarea id="" name="notboard" rows="8" cols="50">
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td>ACHEIVEMENTS</td>
                    <td>
                    <textarea id="" name="acheivements" rows="8" cols="50">
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td>ADMISSION</td>
                    <td>
                    <textarea id="" name="admission" rows="8" cols="50">
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td>SUCCESS STORY</td>
                    <td>
                    <textarea id="" name="successstory" rows="8" cols="50">
                    </textarea>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td><button class="btn btn-success">ADD NOTIFICATION</button></td>
                </tr>
                </table>
                </form>
