    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <form action="{{ route('readfacultyreport') }}" method="post">
                  @csrf
                <table class="table table-borderless">
                <tr>
                    <td><br><h3 style="color:#e6b800"><b>REPORT -FACULTY  DEPARTMENT WISE</b></h3></td>
                </tr>
                <tr>
                    <td>DEPARTMENT NAME</td>
                    <td><select name="department" class="form-control">
                        <option value=""></option>
                        <option value="cs">DEPARTMENT OF COMPUTER</option>
                        <option value="comm">DEPARTMENT OF BUSINESS</option>
                        <option value="soc">DEPARTMENT OF SOCIAL WORK</option>
...
<img src="{{ asset('uploads/facphotos/'. $addmi->facphoto) }}" class="card-img-top" height="250" width="200"  alt="">
  <div class="card-body">
    <h5 class="card-title">{{ $addmi->facname }}</h5>
    <p class="card-text"></p>
  </div>
</div></td>
      <td>{{ $addmi->id }}</td>
      <td>{{ $addmi->facname }}</td>
      <td>{{ $addmi->designation }}</td>
      <td>{{ $addmi->qualification }}</td>
      <td>{{ $addmi->facemail }}</td>
    </tr>
  </tbody>
</table>
