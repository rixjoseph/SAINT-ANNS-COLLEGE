    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <form action="{{ route('readfaculty') }}" method="post" enctype="multipart/form-data">
                  @csrf
                <table class="table table-borderless">
                <tr>
                    <td><br><h3 style="color:#e6b800"><b>ADD FACULTY</b></h3></td>
                </tr>
                <tr>
                    <td>NAME</td>
                    <td><input type="text" class="form-control" name="facname"></td>
                </tr>
                <tr>
                    <td>DESIGNATION</td>
                ...
                <tr>
                    <td>EMAIL</td>
                    <td><input type="email" name="facemail" class="form-control"></td>
                </tr>
                <tr>
                    <td>DEPARTMENT</td>
                    <td>Computer Science<input type="radio"  name="department" value="cs">&nbsp;&nbsp;&nbsp;
                    Commerce<input type="radio"  name="department" value="comm">&nbsp;&nbsp;&nbsp;
                    Social Work<input type="radio"  name="department" value="soc"></td>
                </tr>
                <tr>
                    <td>PROFILE PHOTO</td>
                    <td><input type="file" name="facphoto" class="form-control"></td>
                </tr>
                <tr>
                    <td></td>
                    <td><button class="btn btn-success">ADD FACULTY</button></td>
                </tr>
                </table>
                </form>
