    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <form action="/upscholar" method="post" enctype="multipart/form-data">
           @csrf
            @foreach ($results as $addmi)
                <table class="table table-borderless">
                <tr>
                    <td><br><h3 style="color:#e6b800"><b>VIEW AND UPDATE NOTIFICATION</b></h3></td>
                </tr>
                <tr>
                    <td><b>SCHOLARSHIP NEWS</b></td>
                    <td>
                    <textarea id="" name="scholarship" rows="8" cols="50">{{ $addmi->scholarship }}
                    </textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <textarea id="" name="notboard" rows="8" cols="50">{{ $addmi->notboard }}
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td><b>ACHEIVEMENTS</b></td>
                    <td>
                    <textarea id="" name="acheivements" rows="8" cols="50">{{ $addmi->acheivements }}
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td><b>ADMISSION</b></td>
                    <td>
                    <textarea id="" name="admission" rows="8" cols="50">{{ $addmi->admission }}
                    </textarea>
                    </td>
                </tr>
                <tr>
                    <td><b>SUCCESS STORY</b></td>
                    <td>
                    <textarea id="" name="successstory" rows="8" cols="50">{{ $addmi->successstory }}
                    </textarea>
                    </td>
                </tr>
                <tr>
