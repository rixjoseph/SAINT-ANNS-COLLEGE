...
<h3 style="color:#e6b800"><b>ADMISSION FOR BCA</b></h3>

<h3 style="color:#e6b800"><b>PERSONAL DETAILS</b></h3>
<hr style="height:2px;border-width:0;color:gray;background-color:gray">
<form action="/readbca" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
...
<tr>
    <td>MOBILE NUMBER</td>
    <td><input type="text" class="form-control" name="mobileno" maxlength="10" placeholder="" pattern="{0-9}{10}" required></td>
