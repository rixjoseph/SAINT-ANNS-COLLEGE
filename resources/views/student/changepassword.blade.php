...
<h3 style="color:#e6b800"><b>CHANGE PASSWORD</b></h3>
<hr style="height:2px;border-width:0;color:gray;background-color:gray">
<form action="/readpassword" method="post">
{{ csrf_field() }}
...
<tr>
    <td></td>
    <td><button class="btn btn-warning" onclick="return confirm('Are you sure to change password')">CHANGE PASSWORD</button></td>
</tr>
</table>
</form>
