                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="..\images\backgrounds\studcar2.jpg" height="600px" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                         <b> <h5>WELCOME</h5></b>
                          <p>SAINT ANNS COLLEGE OF MANAGEMENT STUDIES</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                        <img src="..\images\backgrounds\studcar3.jpg" height="600px" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                          <h5>WELCOME</h5>
                          <p>SAINT ANNS COLLEGE OF MANAGEMENT STUDIES</p>
                        </div>
                      ...
                      <div class="carousel-item">
                        <img src="..\images\backgrounds\studcar1.jpg" height="600px" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                          <h5>WELCOME</h5>
                          <p>SAINT ANNS COLLEGE OF MANAGEMENT STUDIES</p>
                        </div>
